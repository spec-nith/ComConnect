...
// Rate limiting removed for task service - handled by API Gateway
// app.use(apiLimiter);
...
const startServer = async () => {
  try {
    console.log('📡 Task Service: Attempting to connect to MongoDB...');
    await Connection();
    
    const PORT = process.env.TASK_SERVICE_PORT || 5005;
